            ...
            <div className='flex justify-center relative my-20 z-10'>
                ...
                justify-center'>
                    ...
                    text-xs text-center text-blue-100 max-w-90'>
                        Elevating Web Experiences with Next-Level Next.js Magic
                    </h2>

                    <TextGenerateEffect 
                        className='text-center text-[40px] md:text-4xl lg:text-5xl'
                        words='Revolutionizing Digital Experiences with Cutting-Edge Web Solutions'
                    />
                    <p className='text-center md:tracking-wider mb-4 text-sm text-blue-200
                    md:text-lg lg:text:2xl'>
                        Hi, I&apos;m Sagar, a seasoned MERN Full Stack Developer based in Toronto. 
                        I transform bold ideas into exceptional digital experiences.
                    </p>
